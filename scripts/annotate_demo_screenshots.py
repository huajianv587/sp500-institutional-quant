...
steps = [
    ...
    ("step-06-file-upload.png", "01-data-status.png", "STEP 6 — Choose the unchanged Capital IQ file"),
    ("step-07-timestamps.png", "01-data-status.png", "STEP 7 — Enter availability and observed timestamps"),
    ("step-08-validation-success.png", "01-data-status.png", "STEP 8 — Validate and import; review provenance"),
